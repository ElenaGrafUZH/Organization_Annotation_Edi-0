...
if (length(args) < 4) {
  stop("Usage: Rscript 03_4_circos_te_density.R <TE_GFF_PATH> <GENE_GFF_PATH> <FAI_PATH> <OUTPUT_DIR>")
}
...
SF_NAMES <- c("Gypsy_LTR_retrotransposon", "Copia_LTR_retrotransposon", 
              "LTR_retrotransposon", "L1_LINE_retrotransposon","Mutator_TIR_transposon")
SF_COLORS <- c("darkgreen", "darkred", "purple", "pink", "blue")
...
PDF_OUT_FILE <- paste0(PLOT_OUTDIR, "03-TE_density_with_gene_density.pdf")
...
PNG_OUT_FILE <- paste0(PLOT_OUTDIR, "03-TE_density_with_gene_density.png")
